...
class UserRecieveDoc extends React.Component{
    constructor(props){
        super(props);
        this.state = {
            Data: '',
    ...
    componentDidMount() {
        var url = 'http://10.16.2.185:8000/Document/getdocument/' ;
...
export default connect(mapStateToProps,mapDispatchToprops)(UserRecieveDoc);
