                    ...
                    <View style={Styles.ContainerContacts}>
                        <View style={{ flexDirection: 'row' }}>
                            ...
                            <View style={{ marginLeft : 20 , marginTop: 20 }}>
                                <Text style={{ color : '#3e48a3' , fontSize: 17 }}>วันที่ทำการนัดคิว: {this.props.chosenDate}</Text> 
                                <Text style={{ color : '#3e48a3' , fontSize: 17 }}>หัวเรื่อง: {this.props.collection.topic}</Text>
                                <Text style={{ color : '#3e48a3' , fontSize: 17 }}>รายละเอียด: {this.props.collection.descriptions}</Text> 
