...
class UsAddAssignment extends React.Component{
  constructor(props) {
    super(props);
    this.state = {
      topic: '',
...
submit(){
  ...
  var url = 'http://35.198.249.38:8000/Document/adddocument/' ;
    ...
    return(
      ...
      <View style={Styles.ContainerContacts}>
          <View style={{ marginLeft : 30 , marginTop : 50 }}>
              ...
              <Text style={{color : '#495090' , fontSize: 20 , fontWeight: 'bold', margin : 5 }}> {this.props.AdDateTimeDetail.name}</Text>
...
export default connect(mapStateToProps)(UsAddAssignment);
